...
public class YTDUINotchHelper {
    private static final String TAG = "YTDUINotchHelper";
    ...
    public static boolean hasNotchInVivo(Context context) {
        ...
        try {
            ...
            YTDLog.i(TAG, "hasNotchInVivo ClassNotFoundException");
        } catch (Exception e) {
            YTDLog.e(TAG, "hasNotchInVivo Exception");
        }
        return ret;
    }
    ...
    public static boolean hasNotchInHuawei(Context context) {
        ...
        try {
            ...
            YTDLog.i(TAG, "hasNotchInHuawei ClassNotFoundException");
        } catch (NoSuchMethodException e) {
            YTDLog.e(TAG, "hasNotchInHuawei NoSuchMethodException");
        } catch (Exception e) {
            YTDLog.e(TAG, "hasNotchInHuawei Exception");
        }
        return hasNotch;
    }
    ...
    public static boolean has3rdNotch(Context context){
        if (YTDUIDeviceHelper.isHuawei()) {
            return hasNotchInHuawei(context);
        } else if (YTDUIDeviceHelper.isVivo()) {
            return hasNotchInVivo(context);
        } else if (YTDUIDeviceHelper.isOppo()) {
            return hasNotchInOppo(context);
        } else if (YTDUIDeviceHelper.isXiaomi()) {
    ...
    private static Rect get3rdSafeInsetRect(Context context){
        // 全面屏设置项更改
        if (YTDUIDeviceHelper.isHuawei()) {
            boolean isHuaweiNotchSetToShow = YTDUIDisplayHelper.huaweiIsNotchSetToShowInSetting(context);
    ...
    private static Rect getRectInfoRotation0(Context context) {
        ...
        if (YTDUIDeviceHelper.isVivo()) {
            ...
            rect.top = YTDUIStatusBarHelper.getStatusbarHeight(context);
            rect.bottom = 0;
        } else if (YTDUIDeviceHelper.isHuawei()) {
    ...
    private static Rect getRectInfoRotation90(Context context) {
        ...
        if (YTDUIDeviceHelper.isVivo()) {
            ...
            rect.left = YTDUIStatusBarHelper.getStatusbarHeight(context);
            rect.right = 0;
        } else if (YTDUIDeviceHelper.isHuawei()) {
    ...
    private static Rect getRectInfoRotation180(Context context) {
        ...
        if (YTDUIDeviceHelper.isVivo()) {
            ...
            rect.top = 0;
            rect.bottom = YTDUIStatusBarHelper.getStatusbarHeight(context);
        } else if (YTDUIDeviceHelper.isHuawei()) {
            int[] notchSize = getNotchSizeInHuawei(context);
            rect.top = 0;
    ...
    private static Rect getRectInfoRotation270(Context context) {
        ...
        if (YTDUIDeviceHelper.isVivo()) {
            ...
            rect.right = YTDUIStatusBarHelper.getStatusbarHeight(context);
            rect.left = 0;
        } else if (YTDUIDeviceHelper.isHuawei()) {
            if (sHuaweiIsNotchSetToShow) {
    ...
    public static int[] getNotchSizeInHuawei(Context context) {
        if (sNotchSizeInHawei == null) {
            ...
            try {
                ...
                YTDLog.e(TAG, "getNotchSizeInHuawei ClassNotFoundException");
            } catch (NoSuchMethodException e) {
                YTDLog.e(TAG, "getNotchSizeInHuawei NoSuchMethodException");
            } catch (Exception e) {
                YTDLog.e(TAG, "getNotchSizeInHuawei Exception");
            }
    ...
    public static int getNotchHeightInXiaomi(Context context) {
        ...
        return YTDUIDisplayHelper.getStatusBarHeight(context);
    }

    public static int getNotchWidthInVivo(Context context){
        return YTDUIDisplayHelper.dp2px(context, 100);
    }

    public static int getNotchHeightInVivo(Context context){
        return YTDUIDisplayHelper.dp2px(context, 27);
    }
    ...
    public static boolean needFixLandscapeNotchAreaFitSystemWindow(View view){
        return (YTDUIDeviceHelper.isXiaomi() || YTDUIDeviceHelper.isVivo()) && YTDUINotchHelper.hasNotch(view);
    }
